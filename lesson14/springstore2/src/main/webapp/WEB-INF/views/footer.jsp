...
<%@ taglib prefix = "c" uri = "http://java.sun.com/jsp/jstl/core" %>
        ...
        <c:choose>
            	<c:when test="${sessionScope.authorized!=null}">
                    ...
                    <h2>Боковое меню</h2>
					<ul>
						<li><a href="product?category=Plan">Training plan</a></li>
						<li><a href="product?category=Meal">Meal Plan</a></li>
						<li><a href="product?category=Online">Online personal workout</a></li>
